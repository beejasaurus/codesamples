...
If(isset($_POST['comment']))
{
  ...
  //$headers['Subject'] = "A message from $name";
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>US Royal Martial Arts | Contact Us - RockvilleTKD@gmail.com - 3017701007</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Contact US Royal Martial Arts (USRMA) at RockvilleTKD@gmail.com, or 3017701007, or stop by at 5244 Randolph Road, Rockville, MD 20852. We are located in Loehmans Plaza between El Patio and Dollar Tree.">
        ...
        <div class="span12">
          ...
          <div class="row">
            <div class="span6">
              ...
              <form class="form-inline" name="sign-up" action="contact.php" method="post">
                <fieldset>
                  <legend>Send Us a Message</legend>
                  <input type="text" placeholder="First and Last Name" name="name" id="name"><br>
                  <input type="text" placeholder="Email Address: Email@Domain.com" name="email" id="email"><br>
                  <input type="text" placeholder="Phone Number: XXX-XXX-XXXX" id="telephone" name="telephone"><br>
                  <textarea rows="4" placeholder="Your message here" id="comment" name="comment"></textarea><br>
              ...
              <h2>Hours:</h2>
              <p>
              <table class="table-striped table-hover span4">
                <tr>
            ...
            <div class="span6">
              <div id="store-front">
                <img src="assets/images/usrma/droppedImage.jpg" class="img-polaroid">
              </div>
